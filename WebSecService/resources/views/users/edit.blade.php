<x-layout>
    <div class="max-w-md mx-auto my-10 bg-white p-6 rounded-lg shadow-md">
        <h1 class="text-2xl font-bold text-blue-600 mb-6 text-center">Edit User</h1>
        ...
        <form method="POST" action="{{ route('users.update', $user) }}" class="space-y-4">
            ...
            <div>
                <label for="password" class="block text-gray-700 font-medium mb-1">New Password (Leave blank to keep current)</label>
                <input
                    type="password"
                    name="password"
                    id="password"
