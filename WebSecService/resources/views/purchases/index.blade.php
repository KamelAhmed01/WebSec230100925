            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="bg-blue-50 border-b border-blue-100 p-4 flex justify-between items-center">
                    ...
                    <div class="text-2xl font-bold text-blue-700">
                        ${{ number_format(Auth::user()->credit->amount ?? 0, 2) }}</div>
                </div>
                ...
                @if ($purchases->isEmpty())
                    <div class="p-8 text-center">
                        ...
                        <a href="{{ route('products_list') }}"
                            class="mt-4 inline-block text-blue-600 hover:text-blue-800 hover:underline font-medium">Browse
                            Products</a>
                    </div>
                @else
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach ($purchases as $purchase)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            <button
                                                class="text-blue-600 hover:text-blue-800 hover:underline toggle-details"
