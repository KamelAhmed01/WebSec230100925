    ...
    <header class="bg-slate-800 shadow-lg text-slate-100">
        <nav class="flex items-center justify-between p-5 max-w-screen-lg mx-auto">
            ...
            <div class="flex items-center space-x-4">
                @auth
                    @can('make_purchases')
                    <a href="{{ route('purchases.index') }}" class="relative mr-2 px-2 py-2 rounded-full hover:bg-slate-700 transition-colors duration-200 flex items-center justify-center text-white">
                    ...
                    <div class="relative">
                        ...
                        <div id="profileDropdown" class="absolute right-0 mt-3 w-64 bg-white rounded-lg shadow-xl py-2 z-50 hidden transform transition-all duration-200 border border-slate-200">
                            ...
                            <div class="py-2">
                                ...
                                @can('view_purchases')
                                <a href="{{ route('purchases.index') }}" class="flex items-center px-6 py-3 text-sm text-slate-700 hover:bg-slate-50 transition-colors duration-150">
